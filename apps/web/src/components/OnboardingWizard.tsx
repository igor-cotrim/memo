...
export default function OnboardingWizard({ onComplete }: OnboardingWizardProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-1000 overflow-y-auto animate-fade-in">
      <div className="flex min-h-full items-center justify-center p-6">
        <div
          ref={panelRef}
          className="bg-bg-secondary border border-border rounded-xl w-full max-w-[560px] p-10 shadow-lg animate-modal-slide-up"
          role="dialog"
          aria-modal="true"
