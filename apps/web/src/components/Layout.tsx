...
export default function Layout() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <footer className="border-t border-border bg-bg-glass backdrop-blur-xl px-8 max-sm:px-4 py-4 flex items-center justify-between gap-4 max-sm:flex-col max-sm:text-center">
        <span className="text-text-muted text-xs font-display">
          © {new Date().getFullYear()} Memô — MIT License
        </span>
        <a
          href="https://github.com/igor-cotrim/memo"
          target="_blank"
