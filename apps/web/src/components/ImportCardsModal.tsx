  ...
  return (
    <Modal onClose={onClose} ariaLabelledBy="import-cards-modal-title">
      <div className="flex items-center justify-between mb-6">
        <h2 className="font-display text-xl font-bold tracking-tight" id="import-cards-modal-title">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              ...
              {file ? (
                ...
                <p className="text-text-secondary text-sm">{t('cards.importDropHint')}</p>
              )}
            </div>
            <p className="text-text-secondary text-xs">{t('cards.importFileHint')}</p>
          </div>
