...
export default function DeckModal({ deck, onClose, onSave }: DeckModalProps) {
  ...
  const { errors, validate, clearFieldError } = useFormValidation({ name: { required: true } }, t);
  ...
  return (
    <Modal onClose={onClose} ariaLabelledBy="deck-modal-title">
      <div className="flex items-center justify-between mb-6">
        <h2 className="font-display text-xl font-bold tracking-tight" id="deck-modal-title">
