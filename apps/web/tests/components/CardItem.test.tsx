...
describe('CardItem', () => {
  it('renders front and back text', () => {
    renderWithProviders(<CardItem card={baseCard} index={0} onEdit={vi.fn()} onDelete={vi.fn()} />);
  ...
  it('shows rep count when reps > 0', () => {
    ...
    renderWithProviders(<CardItem card={card} index={0} onEdit={vi.fn()} onDelete={vi.fn()} />);
  ...
  it('calls onEdit when edit button is clicked', async () => {
    ...
    renderWithProviders(<CardItem card={baseCard} index={0} onEdit={onEdit} onDelete={vi.fn()} />);
  ...
  it('calls onDelete when delete button is clicked', async () => {
    ...
    renderWithProviders(
      <CardItem card={baseCard} index={0} onEdit={vi.fn()} onDelete={onDelete} />,
    );
