...
describe('ReviewScoreButtons', () => {
  it('renders 4 quality buttons', () => {
    renderWithProviders(
      <ReviewScoreButtons onRate={vi.fn()} disabled={false} activeQuality={null} />,
    );
  ...
  it('calls onRate with correct quality when clicked', async () => {
    ...
    renderWithProviders(
      <ReviewScoreButtons onRate={onRate} disabled={false} activeQuality={null} />,
    );
  ...
  it('disables buttons when disabled prop is true', () => {
    renderWithProviders(
      <ReviewScoreButtons onRate={vi.fn()} disabled={true} activeQuality={null} />,
    );
