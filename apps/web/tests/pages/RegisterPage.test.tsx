...
describe('RegisterPage', () => {
  ...
  it('submits register form successfully', async () => {
    ...
    await user.click(screen.getByText('Create Account', { selector: 'button' }));

    expect(register).toHaveBeenCalledWith('john@example.com', 'John Doe', 'SecurePass123!');
  });
  ...
  it('shows loading state while submitting', async () => {
    ...
    const register = vi.fn(() => new Promise<void>((r) => (resolveRegister = r)));
